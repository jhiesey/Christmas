...
ROM const unsigned char cdc_str_descs[] = {
        ...
        /* USB_iManufacturer */ 42, USB_STRING_DESCRIPTOR_TYPE, 'J',0,'o',0,'h',0,'n',0,' ',0,'H',0,'i',0,'e',0,'s',0,'e',0,'y',0,
        /* USB_iProduct */      18, USB_STRING_DESCRIPTOR_TYPE, 'C',0,'h',0,'r',0,'i',0,'s',0,'t',0,'m',0,'a',0,'s',0,'!',0,
