/* 
 * File:   prj_usb_config.h
 * Author: jhiesey
 *
 * Created on December 22, 2012, 7:26 PM
 */

#ifndef PRJ_USB_CONFIG_H
#define	PRJ_USB_CONFIG_H
...
#define UART_BAUD_setup(x) Nop()
#define CDC_FLUSH_MS 4

#define USB_INTERRUPTS

#endif	/* PRJ_USB_CONFIG_H */
